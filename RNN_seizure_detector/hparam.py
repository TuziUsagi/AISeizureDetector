...
def gethparam():
  ...
  hparams = {'train_data':[datasetBucket+'train.tfrecord'],
             ...
             'numOfCores': 4,		# Use multiple cores to do date pre-processing
              # Input data setup
             'upSamplingFactor': 1, # Upsample the input signal
             ...
             'learning_rate':0.01, 
             'reg_constant': 0.05, # L2 regulation
             'AdamBeta1': 0.9,
             'AdamBeta2': 0.999,
             'epsilon': 1e-7,
